      ...
      <div className='text-lg space-y-4'>
        ...
        <div className="flex flex-col items-center mt-6 space-y-2">
          <h3 className="text-xl font-semibold text-[#001B5E]">
            My Artifact: Headphones
          </h3>

          <img
            src={img}
            alt={title}
            className="w-[220px] h-auto rounded-xl shadow-md"
          />

          <p className="text-sm text-gray-500 text-center max-w-[300px]">
            A small object that represents focus, independence, and connection in my daily life.
          </p>
        </div>
      </div>
    </div>
